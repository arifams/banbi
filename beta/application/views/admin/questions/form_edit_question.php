<div class="col-md-12">
    <form action="<?php echo current_full_url() ?>" method="post"enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="hidden" name="answer_id[]" value="<?php echo $a->answer ?>" />
                <input type="text" name="answer[]" class="form-control" value="<?php echo $a->answer ?>" placeholder="" />
            </div>
            <div class="col-md-2">
                <input type="radio" name="correct" value="<?php echo $a->answer_id ?>" <?php if ($answer_id == $a->answer_id) echo "checked" ?> /> correct answer
            </div>
        </div>
        <?php $i++ ?>
        <?php endforeach; ?>
