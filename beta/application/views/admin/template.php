...
<html lang="en">
    ...
    <head>
        ...
        <title>Banbibe Content Management System</title>
        ...
        <link href="<?php echo base_url() ?>assets/admin/bower_components/bootstrap-summernote/summernote.css" rel="stylesheet">
        ...
        <script src="<?php echo base_url() ?>assets/admin/bower_components/bootstrap-summernote/summernote.min.js"></script>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url() ?>">Banbi.be CMS</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="<?php echo admin_url() ?>logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                            </li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
